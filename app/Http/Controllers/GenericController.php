...
*/        
    ...
    public function storeRecords(Request $request, $tableName) {
        ...
        if ( !$result ) $returnData['errors'] = 'An error was encountered saving the Records';
...
*/
    ...
    private function setSelectAndJoins(Request $request, $tableName, &$query) {
        ...
        } else if (!$request->select && !$request->selectraw && !$request->columnraw && !$request->column) {

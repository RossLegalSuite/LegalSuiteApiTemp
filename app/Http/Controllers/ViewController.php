...
class ViewController extends Controller
{
    ...
    public function viewCaller(Request $request)
    {
            ...
            if ($request->tableName) {
                ...
                return json_encode(array('errors' => 'Please enter Table Name'));
            }
    ...
    public function viewCreator(Request $request)
    {
        ...
        if ($request->viewname && $request->sql) {
            ...
            return json_encode(array('Success' => "You may access the view at legalsuiteapi.co.za".'/'."". $request->user()->appId.$request->viewname),JSON_UNESCAPED_SLASHES).'/'."get";
            
        }else{
            return json_encode(array('errors' => 'View Name or Sql Not found'));
        }

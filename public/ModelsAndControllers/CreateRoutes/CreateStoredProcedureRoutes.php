	...
	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_generateansiname', 'StoredProcedureControllers\dt_generateansinameController@parameters');
	Route::post('/dt_generateansiname', 'StoredProcedureControllers\dt_generateansinameController@execute');
	...
	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_adduserobject', 'StoredProcedureControllers\dt_adduserobjectController@parameters');
	Route::post('/dt_adduserobject', 'StoredProcedureControllers\dt_adduserobjectController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_setpropertybyid', 'StoredProcedureControllers\dt_setpropertybyidController@parameters');
	Route::post('/dt_setpropertybyid', 'StoredProcedureControllers\dt_setpropertybyidController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_getobjwithprop', 'StoredProcedureControllers\dt_getobjwithpropController@parameters');
	Route::post('/dt_getobjwithprop', 'StoredProcedureControllers\dt_getobjwithpropController@execute');
	...
	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_getpropertiesbyid', 'StoredProcedureControllers\dt_getpropertiesbyidController@parameters');
	Route::post('/dt_getpropertiesbyid', 'StoredProcedureControllers\dt_getpropertiesbyidController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_setpropertybyid_u', 'StoredProcedureControllers\dt_setpropertybyid_uController@parameters');
	Route::post('/dt_setpropertybyid_u', 'StoredProcedureControllers\dt_setpropertybyid_uController@execute');
	...
	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_getobjwithprop_u', 'StoredProcedureControllers\dt_getobjwithprop_uController@parameters');
	Route::post('/dt_getobjwithprop_u', 'StoredProcedureControllers\dt_getobjwithprop_uController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_getpropertiesbyid_u', 'StoredProcedureControllers\dt_getpropertiesbyid_uController@parameters');
	Route::post('/dt_getpropertiesbyid_u', 'StoredProcedureControllers\dt_getpropertiesbyid_uController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_dropuserobjectbyid', 'StoredProcedureControllers\dt_dropuserobjectbyidController@parameters');
	Route::post('/dt_dropuserobjectbyid', 'StoredProcedureControllers\dt_dropuserobjectbyidController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_droppropertiesbyid', 'StoredProcedureControllers\dt_droppropertiesbyidController@parameters');
	Route::post('/dt_droppropertiesbyid', 'StoredProcedureControllers\dt_droppropertiesbyidController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_verstamp006', 'StoredProcedureControllers\dt_verstamp006Controller@parameters');
	Route::post('/dt_verstamp006', 'StoredProcedureControllers\dt_verstamp006Controller@execute');
	...
	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_verstamp007', 'StoredProcedureControllers\dt_verstamp007Controller@parameters');
	Route::post('/dt_verstamp007', 'StoredProcedureControllers\dt_verstamp007Controller@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_getpropertiesbyid_vcs', 'StoredProcedureControllers\dt_getpropertiesbyid_vcsController@parameters');
	Route::post('/dt_getpropertiesbyid_vcs', 'StoredProcedureControllers\dt_getpropertiesbyid_vcsController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_displayoaerror', 'StoredProcedureControllers\dt_displayoaerrorController@parameters');
	Route::post('/dt_displayoaerror', 'StoredProcedureControllers\dt_displayoaerrorController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_adduserobject_vcs', 'StoredProcedureControllers\dt_adduserobject_vcsController@parameters');
	Route::post('/dt_adduserobject_vcs', 'StoredProcedureControllers\dt_adduserobject_vcsController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_addtosourcecontrol', 'StoredProcedureControllers\dt_addtosourcecontrolController@parameters');
	Route::post('/dt_addtosourcecontrol', 'StoredProcedureControllers\dt_addtosourcecontrolController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_checkinobject', 'StoredProcedureControllers\dt_checkinobjectController@parameters');
	Route::post('/dt_checkinobject', 'StoredProcedureControllers\dt_checkinobjectController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_checkoutobject', 'StoredProcedureControllers\dt_checkoutobjectController@parameters');
	Route::post('/dt_checkoutobject', 'StoredProcedureControllers\dt_checkoutobjectController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_isundersourcecontrol', 'StoredProcedureControllers\dt_isundersourcecontrolController@parameters');
	Route::post('/dt_isundersourcecontrol', 'StoredProcedureControllers\dt_isundersourcecontrolController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_removefromsourcecontrol', 'StoredProcedureControllers\dt_removefromsourcecontrolController@parameters');
	Route::post('/dt_removefromsourcecontrol', 'StoredProcedureControllers\dt_removefromsourcecontrolController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_validateloginparams', 'StoredProcedureControllers\dt_validateloginparamsController@parameters');
	Route::post('/dt_validateloginparams', 'StoredProcedureControllers\dt_validateloginparamsController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_vcsenabled', 'StoredProcedureControllers\dt_vcsenabledController@parameters');
	Route::post('/dt_vcsenabled', 'StoredProcedureControllers\dt_vcsenabledController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_whocheckedout', 'StoredProcedureControllers\dt_whocheckedoutController@parameters');
	Route::post('/dt_whocheckedout', 'StoredProcedureControllers\dt_whocheckedoutController@execute');
	...
	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_getpropertiesbyid_vcs_u', 'StoredProcedureControllers\dt_getpropertiesbyid_vcs_uController@parameters');
	Route::post('/dt_getpropertiesbyid_vcs_u', 'StoredProcedureControllers\dt_getpropertiesbyid_vcs_uController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_displayoaerror_u', 'StoredProcedureControllers\dt_displayoaerror_uController@parameters');
	Route::post('/dt_displayoaerror_u', 'StoredProcedureControllers\dt_displayoaerror_uController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_addtosourcecontrol_u', 'StoredProcedureControllers\dt_addtosourcecontrol_uController@parameters');
	Route::post('/dt_addtosourcecontrol_u', 'StoredProcedureControllers\dt_addtosourcecontrol_uController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_checkinobject_u', 'StoredProcedureControllers\dt_checkinobject_uController@parameters');
	Route::post('/dt_checkinobject_u', 'StoredProcedureControllers\dt_checkinobject_uController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_checkoutobject_u', 'StoredProcedureControllers\dt_checkoutobject_uController@parameters');
	Route::post('/dt_checkoutobject_u', 'StoredProcedureControllers\dt_checkoutobject_uController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_isundersourcecontrol_u', 'StoredProcedureControllers\dt_isundersourcecontrol_uController@parameters');
	Route::post('/dt_isundersourcecontrol_u', 'StoredProcedureControllers\dt_isundersourcecontrol_uController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_validateloginparams_u', 'StoredProcedureControllers\dt_validateloginparams_uController@parameters');
	Route::post('/dt_validateloginparams_u', 'StoredProcedureControllers\dt_validateloginparams_uController@execute');

	});

	Route::middleware('authenticate')->prefix('storedprocedure')->group(function () {
	Route::get('/dt_whocheckedout_u', 'StoredProcedureControllers\dt_whocheckedout_uController@parameters');
	Route::post('/dt_whocheckedout_u', 'StoredProcedureControllers\dt_whocheckedout_uController@execute');

...
class DebtorsAccountController extends Controller
{
            ...
            if ( $this->debugging ) {
                ...
                foreach ($this->queue as $dateArray) {
                    ...
                    foreach ($dateArray as $colDebit) {
                        ...
                        echo "\n\t\t\t\t\t\t\t\tCostBalance:" . $colDebit->costbalance . "\tInterestBalance:" . $colDebit->interestbalance . "\tCapital Balance:" . $colDebit->capitalbalance;//  . " " . $colDebit->balance; 
                    }
                }
    ...
    private function addInterestToQueue() {
        ...
        //$this->insertInterestRecord($interestRecord);
    ...
    private function adjustTheBalances(&$colDebit) {
        ...
        if ($colDebit->type == 'D') {   // COST
            ...
            if ( floatval($this->CalculateInterestOn) && floatval($colDebit->interestrate) ) {

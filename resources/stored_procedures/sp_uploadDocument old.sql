CREATE PROCEDURE dbo.sp_UploadDocument (@RecordID int ) AS
...
BEGIN
	...
	BEGIN	
		...
		'echo user legalsuiteftp> '+ @DATName  + CHAR(13) + CHAR(10) +
		'echo Bacon1024!!>> '+ @DATName  + CHAR(13) + CHAR(10) +
		'echo bin>> '+ @DATName  + CHAR(13) + CHAR(10) +
		'echo cd legalsuiteftp>> '+ @DATName  + CHAR(13) + CHAR(10) +
		...
		'ftp -n -s:'+@DATName+' legalsuite.online' + CHAR(13) + CHAR(10) +
		'del '+ @DATName 
		...
		SET @Url = 'https://www.legalsuite.online/legalsuiteftp/' + @FirmCode + '/' + REPLACE(@FileRef,'/','') + '/' + @FileNameNoDir 
